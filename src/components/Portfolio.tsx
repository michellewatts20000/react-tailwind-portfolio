...
function NextArrow(props: ArrowProps) {
  ...
  return (
    <FontAwesomeIcon
      icon={faChevronRight}
      onClick={onClick}
      className={`${className} text-black hover:gray-900 text-5xl`}
      style={{
        ...style,
        position: 'absolute',
        top: '50%',
...
function PrevArrow(props: ArrowProps) {
  ...
  return (
    <FontAwesomeIcon
      icon={faChevronLeft}
      onClick={onClick}
      className={`${className} text-black hover:text-primary-500 text-5xl`}
      style={{
        ...style,
        position: 'absolute',
        top: '50%',
...
const Portfolio = (props: PortfolioItemProps) => {
  const { items } = props
  ...
  return (
    <section
      id="portfolio"
      className="bg-twilight-500 pt-10 pb-20 px-10 relative"
    >
              ...
              <div key={item.sys.id} className="bg-transparent p-6">
                ...
                <div className="mt-8 flex flex-col gap-2 sm:gap-4 mb:flex-row items-center justify-center">
                  <a
                    ...
                    rel="noopener noreferrer"
                    target="_blank"
                    className="rounded-full bg-primary-500 hover:bg-primary-600 text-white text-clampButton font-semibold py-2 px-4 lg:px-6 transition duration-300"
                  >
                    Demo
                  ...
                  {item.fields.github && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      target="_blank"
                      className="rounded-full bg-secondary-500 hover:bg-secondary-600 text-white text-clampButton font-semibold py-2 px-4 lg:px-6 transition duration-300"
                    >
                      GitHub
